package com.newrelic.aws.cfn.resources.alert.policychannelassociation.nerdgraph;
...
import com.newrelic.aws.cfn.resources.alert.policychannelassociation.nerdgraph.schema.Response;
import com.newrelic.aws.cfn.resources.alert.policychannelassociation.nerdgraph.schema.ResponseData;
import com.newrelic.aws.cfn.resources.alert.policychannelassociation.nerdgraph.schema.ResponseError;
...
public class NerdGraphClient {
    ...
    public <T extends PolicyChannelAssociationResult> ResponseData<T> doRequest(Class<T> resultType,
                                                                                String endpoint,
                                                                                String variables,
                                                                                String apiKey,
                                                                                String query)
