...
import com.newrelic.aws.cfn.resources.alert.notificationchannel.nerdgraph.schema.Response;
import com.newrelic.aws.cfn.resources.alert.notificationchannel.nerdgraph.schema.ResponseData;
import com.newrelic.aws.cfn.resources.alert.notificationchannel.nerdgraph.schema.ResponseError;
...
public class NerdGraphClient {
    ...
    public <T extends NotificationChannelResult> ResponseData<T> doRequest(Class<T> resultType,
                                                                           String endpoint,
                                                                           String variables,
                                                                           String apiKey,
                                                                           String query)
