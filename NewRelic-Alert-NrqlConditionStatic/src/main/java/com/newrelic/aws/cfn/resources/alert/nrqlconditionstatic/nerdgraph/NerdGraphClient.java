...
import com.newrelic.aws.cfn.resources.alert.nrqlconditionstatic.nerdgraph.schema.Response;
import com.newrelic.aws.cfn.resources.alert.nrqlconditionstatic.nerdgraph.schema.ResponseData;
import com.newrelic.aws.cfn.resources.alert.nrqlconditionstatic.nerdgraph.schema.ResponseError;
...
public class NerdGraphClient {
    ...
    public <T extends NrqlConditionStaticResult> ResponseData<T> doRequest(Class<T> resultType,
                                                                           String endpoint,
                                                                           String variables,
                                                                           String apiKey,
                                                                           String query)
